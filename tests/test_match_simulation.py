...
from models.player import Player, PlayerAttributes, PlayerCondition, PlayerContract, PlayerStats
...
class TestVolleyballSimulator:
    ...
    def test_simulate_match_basic(self):
        ...
        result = self.simulator.simulate_match(self.home_team, self.away_team, self.tactics)
    ...
    def test_team_strength_calculation(self):
        ...
        home_strength = self.simulator._calculate_team_strength(self.home_team, self.tactics['home'])
    ...
    def test_formation_bonuses(self):
        ...
        strength_62 = self.simulator._calculate_team_strength(self.home_team, tactics_62)
        strength_51 = self.simulator._calculate_team_strength(self.home_team, tactics_51)
        strength_42 = self.simulator._calculate_team_strength(self.home_team, tactics_42)
    ...
    def test_attendance_calculation(self):
        ...
        attendance = self.simulator._calculate_attendance(self.home_team, self.away_team)
    ...
    def test_revenue_calculation(self):
        ...
        expected_total = revenue['tickets'] + revenue['concessions'] + revenue['merchandise']
