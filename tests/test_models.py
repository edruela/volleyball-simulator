...
from models.player import Player, PlayerAttributes, PlayerCondition, PlayerContract, PlayerStats, generate_random_player
...
class TestClub:
    ...
    def test_club_finances_scaling(self):
        ...
        elite_club = Club(
            id="elite", name="Elite Club", short_name="EC",
            country_id="testland", division_tier=1
        )
        
        amateur_club = Club(
            id="amateur", name="Amateur Club", short_name="AC", 
            country_id="testland", division_tier=19
        )
    ...
    def test_club_to_dict_conversion(self):
        ...
        club = Club(
            id="test_club", name="Test Club", short_name="TC",
            country_id="testland", division_tier=10
        )
    ...
    def test_club_overall_rating(self):
        ...
        club = Club(
            id="test_club", name="Test Club", short_name="TC",
            country_id="testland", division_tier=1  # Elite tier
        )
...
class TestPlayer:
    ...
    def test_player_overall_rating_by_position(self):
        ...
        base_attributes = PlayerAttributes(
            spike_power=80, spike_accuracy=80, block_timing=80,
            passing_accuracy=80, setting_precision=80, serve_power=80,
            serve_accuracy=80, court_vision=80, decision_making=80,
            communication=80, stamina=80, strength=80, agility=80,
            jump_height=80, speed=80
        )
    ...
    def test_player_condition_effects(self):
        ...
        healthy_player = Player(
            id="healthy", first_name="Healthy", last_name="Player",
            club_id="test_club", country_id="testland", age=25, position="OH",
            attributes=attributes,
        ...
        tired_player = Player(
            id="tired", first_name="Tired", last_name="Player",
            club_id="test_club", country_id="testland", age=25, position="OH",
            attributes=attributes,
    ...
    def test_player_fatigue_recovery(self):
        ...
        player = Player(
            id="test_player", first_name="Test", last_name="Player",
            club_id="test_club", country_id="testland", age=25, position="OH",
...
class TestPlayerGeneration:
    ...
    def test_player_generation_by_division(self):
        ...
        elite_player = generate_random_player("club1", "testland", "OH", division_tier=1)
        amateur_player = generate_random_player("club2", "testland", "OH", division_tier=19)
